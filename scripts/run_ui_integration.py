...
def main():
    ...
    parser.add_argument("--open-workspace", action="store_true")
    ...
    with tempfile.TemporaryDirectory(prefix="api-", dir=artifacts) as temporary:
        ...
        env.update(
            {
                ...
                "REWIND_BROWSER_OPEN_ACCESS": str(args.open_workspace).lower(),
                "REWIND_WORKERS": "0",
        ...
        with log_path.open("wb") as log:
            ...
            try:
                ...
                result = subprocess.run([args.node, str(args.script.resolve())], cwd=root, env=env)
